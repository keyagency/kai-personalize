...
return [
    ...
    'permissions' => [
        ...
        'manage_blacklists' => 'Blacklist Beheren',
    ...
    'blacklists' => [
        'title' => 'Blacklist',
        'add' => 'Blacklist Item Toevoegen',
        'add_first' => 'Voeg Eerste Item Toe',
        'create' => 'Item Aanmaken',
        'edit' => 'Item Bewerken',
        'delete' => 'Item Verwijderen',
        'logs' => 'Logs',
        'empty' => 'Geen blacklist items gevonden.',
        'type' => 'Type',
        'pattern' => 'Patroon',
        'description' => 'Beschrijving',
        'is_active' => 'Actief',
        'hit_count' => 'Hit Aantal',
        'last_hit' => 'Laatste Hit',
        'created' => 'Blacklist item aangemaakt!',
        'updated' => 'Blacklist item bijgewerkt!',
        'deleted' => 'Blacklist item verwijderd!',
    ],
];
